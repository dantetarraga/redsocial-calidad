...
const { Conversacion } = require("../models/conversationsModel.js");
...
class conversacionesController {
  ...
  static async obtenerConversacionesUsuario(req, res) {
    ...
    try {
      ...
      return res
        .status(500)
        .json({ error: "Error al obtener las conversaciones del usuario" });
    }
  }
  ...
  static async obtenerConversacionPorId(req, res) {
    ...
    try {
      ...
      const conversacionId = req.params.conversationId;
      ...
      return res
        .status(500)
        .json({ error: "Error al obtener la conversación" });
    }
  }

  // Eliminar conversaciones?
}
module.exports = conversacionesController;
